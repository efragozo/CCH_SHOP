...
<div class="download_pop_tbf">
	<div class="content">
		...
		<p class="title">Aggiorna alla Versione Pro per un Recupero Senza Limite!</p>
        
        
        <div class="re_box">
          <div class="box current">
          	<img src="images/icon-6.png" class="img_p" />
          	<p class="t"><span>1</span> -<font> Mese </font><br /> Abbonamento</p>
          	<p class="price"><font>46,<sup>69 €</sup></font><del>66,69 €</del></p>
          	<p class="btn"><a class="button" href="easeusbuybuttonhttps://order.easeus.com/505/purl-inapp-one-month-free-it?x-source=inapp_drw_free_1332020050711&x-url=1332020050711-">Acquista Ora</a></p>
            <ul class="list2">
                <li><img src="images/icon-4.png" />Aggiorna gratis per<strong> 1 mese</strong></li>
                <li><img src="images/icon-4.png" />Annulla in qualsiasi momento</li>            
        	</ul>
          </div>
        
          <div class="box last">
          	<p class="t"><span>1</span> -<font> Anno </font><br /> Abbonamento</p>
          	<p class="price">96<sup>,69</sup><sup>€</sup></p>
          	<p class="btn"><a class="button" href="easeusbuybuttonhttps://order.easeus.com/505/purl-inapp-one-year-free?x-source=inapp_drw_free_1332020050711&x-url=1332020050711-">Acquista Ora</a></p>
            <ul class="list2">
                <li><img src="images/icon-4.png" />Aggiorna gratis per <b>1 anno</b></li>
                <li><img src="images/icon-4.png" />Annulla in qualsiasi momento</li>
        	</ul>
          </div>
          <div class="box">
        	
          	<p class="t"><font>Aggiorna a Vita</font></p>
          	<p class="price">146<sup>,69</sup><sup>€</sup></p>
          	<p class="btn"><a class="button" href="easeusbuybuttonhttps://order.easeus.com/505/purl-inapp-drwa-free?x-source=inapp_drw_free_1332020050711&x-url=1332020050711-">Acquista Ora</a></p>
            <ul class="list2">
                <li><img src="images/icon-4.png" />Aggiorna gratis <b>a vita</b></li>
                <li><img src="images/icon-4.png" />Acquisto una-volta</li>
        ...
        <ul class="list">
        	<li><span><img src="images/icon-1.png" /></span>Rimborso entro 30 giorni</li>
        	<li><span><img src="images/icon-2.png" /></span>Supporto tecnico gratuito</li>
            <li><span><img src="images/icon-3.png" /></span>Consegna subito via mail 7/24</li>
